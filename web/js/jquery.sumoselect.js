        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="CaptionCont"><label><i class="fa fa-chevron-down"></i></label></p>').addClass('SlectBox').attr('style', O.E.attr('style')).prepend(O.caption);
                ...
                createLi: function (opt,i) {
                    ...
                    if (O.is_multi) li.prepend('<span><i class="fa fa-chevron-down" ></i></span>');
